 ...
 * 
 */
@WebServiceClient(name = "CustomerPortService", targetNamespace = "http://ivosam.com.br", wsdlLocation = "http://localhost:8080/ws/customers.wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERPORTSERVICE_QNAME = new QName("http://ivosam.com.br", "CustomerPortService");
    ...
    public CustomerPort getCustomerPortSoap11() {
        return super.getPort(new QName("http://ivosam.com.br", "CustomerPortSoap11"), CustomerPort.class);
    }
    ...
    public CustomerPort getCustomerPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://ivosam.com.br", "CustomerPortSoap11"), CustomerPort.class, features);
    }
